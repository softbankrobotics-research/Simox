...
#include "showVisualizationTestWindow.h"
...
showVisualizationTestWindow::showVisualizationTestWindow(std::string test)
    : QMainWindow(NULL)
{
    setupUI();
    viewer->viewAll();
...
showVisualizationTestWindow::~showVisualizationTestWindow()
{
}


void showVisualizationTestWindow::setupUI()
{
    UI.setupUi(this);
...
int showVisualizationTestWindow::main()
{
