...
namespace VirtualRobot
{
     ...
     * to EndEffectorIO::processEndeffectorActorNode and EndEffectorIO::processEndeffectorStaticNode.
     *
     * \return instance of VirtualRobot::EndEffector
     */
    EndEffectorPtr EndEffectorIO::processEndeffectorNode(rapidxml::xml_node<char>* endeffectorXMLNode, RobotPtr robo)
    {
     ...
     */
    EndEffectorActorPtr EndEffectorIO::processEndeffectorActorNode(rapidxml::xml_node<char>* endeffectorActorXMLNode, RobotPtr robo)
    {
     ...
     * itself is a child of the endeffector tag.
     */
    void EndEffectorIO::processEndeffectorStaticNode(rapidxml::xml_node<char>* endeffectorStaticXMLNode, RobotPtr robo, std::vector<ModelLinkPtr>& staticNodesList)
    {
     ...
     */
    void EndEffectorIO::processActorNodeList(rapidxml::xml_node<char>* parentNode, RobotPtr robot, std::vector<EndEffectorActor::ActorDefinition>& actorList, bool clearList /*= true*/)
    {
        if (clearList)
        {
            actorList.clear();
    ...
    EndEffectorActor::CollisionMode EndEffectorIO::processEEFColAttributes(rapidxml::xml_node<char>* node, bool allowOtherAttributes /* = false */)
    {
    ...
    bool EndEffectorIO::loadEndEffectors(const RobotPtr &robot, const std::string &filename)
    {
