...
namespace VirtualRobot
{
    ...
    public:
        ...
        virtual float calculateDistance(const CollisionModelPtr &model1, const CollisionModelPtr &model2, Eigen::Vector3f& P1, Eigen::Vector3f& P2, int* trID1 = nullptr, int* trID2 = nullptr) = 0;
        virtual bool checkCollision(const CollisionModelPtr &model1, const CollisionModelPtr &model2) = 0; //, Eigen::Vector3f *storeContact = nullptr) = 0;
