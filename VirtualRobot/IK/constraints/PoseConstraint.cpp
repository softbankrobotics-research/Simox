...
PoseConstraint::PoseConstraint(const ModelPtr& robot, const JointSetPtr& nodeSet, const FramePtr& eef, const Eigen::Matrix4f& target, IKSolver::CartesianSelection cartesianSelection,
