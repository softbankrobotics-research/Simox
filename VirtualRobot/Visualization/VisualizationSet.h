...
namespace VirtualRobot
{
    ...
    public:
        ...
        virtual bool getUpdateVisualizationStatus() const override = 0;
        ...
        virtual DrawStyle getStyle() const override = 0;
    ...
    public:
        ...
        virtual std::vector<Primitive::PrimitivePtr> getPrimitives() const override = 0;
    ...
    class VIRTUAL_ROBOT_IMPORT_EXPORT DummyVisualizationSet : public VisualizationSet, public DummyVisualization
    {
