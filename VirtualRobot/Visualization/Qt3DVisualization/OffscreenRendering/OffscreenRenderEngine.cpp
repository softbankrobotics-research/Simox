...
VirtualRobot::OffscreenRenderEngine::OffscreenRenderEngine(Qt3DRender::QCamera *camera, const QSize &size)
{
    sceneRoot = nullptr;
    ...
    offscreenRenderEngineFrameGraph = new OffscreenRenderEngineFrameGraph(renderSettings, camera, size);
