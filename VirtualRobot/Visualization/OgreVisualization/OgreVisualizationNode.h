...
*
*/
#ifndef _VirtualRobot_OgreVisualizationNode_h_
#define _VirtualRobot_OgreVisualizationNode_h_
...
namespace VirtualRobot
{
    ...
    class VIRTUAL_ROBOT_IMPORT_EXPORT OgreVisualizationNode : virtual public VisualizationNode
    {
    ...
    public:
        ...
        */
        ...
        {
            return OgreVisualizationFactory::getName();
        }
    ...
    protected:
        ...
        */
        ...
        std::map< std::string, SoNode* > attachedOgreVisualizations;    //< These optional visualizations will not show up in the TriMeshModel
    ...
    typedef boost::shared_ptr<OgreVisualizationNode> OgreVisualizationNodePtr;

} // namespace VirtualRobot

#endif // _VirtualRobot_OgreVisualizationNode_h_
