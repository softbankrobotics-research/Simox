...
{
    class VIRTUAL_ROBOT_IMPORT_EXPORT FrameAttachmentFactory : public ModelNodeAttachmentFactory
    {
    protected:
        /*!
         * Constructor.
         */
        FrameAttachmentFactory();

    public:
        /*!
         * Destructor.
         */
        virtual ~FrameAttachmentFactory() override;
    ...
    typedef std::shared_ptr<FrameAttachmentFactory> FrameAttachmentFactoryPtr;
}
